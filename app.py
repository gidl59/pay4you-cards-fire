...
app.secret_key = "pay4you_2026_platinum_ultra"
...
def download_vcf(slug):
    ...
    if p.get('address'): vcard.append(f"ADR;TYPE=WORK:;;{p.get('address').replace(',', ';')};;;;")
    vcard.append("END:VCARD")
    
    response = make_response("\r\n".join(vcard)) # CRLF per compatibilità massima
